...
- Clone this repo: `git clone git@github.com:gluecodes/gluecodes-dashboards.git`.
...
- Your component might use multiple providers. They are called in a specific order prior initial rendering and pipe through `actionResults` to give a provider access to a result of previous one. Read more about [providers](https://github.com/gluecodes/gluecodes-dashboards/blob/master/providers.md) and how to define their execution order.
...
Remember that when installing a widget within [GlueCodes IDE](https://www.glue.codes), this function will be transformed and then inserted into the page code. This level of automation requires a few simple rules when writing your testing data function. [Read more](https://github.com/gluecodes/gluecodes-dashboards/blob/master/getTestingData.md).
